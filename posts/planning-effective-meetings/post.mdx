...
Handling discussions in meetings can be challenging. The following guide is a summary loosely based on Antony Jay's [How to Run a Meeting](https://hbr.org/1976/03/how-to-run-a-meeting).
...
Recurring meetings tend to fall here. Note that <Q {...q.mckinsey}>recurring meetings can become diffuse over time (and might require reviewing with stakeholders to ensure that the frequency is right).</Q>
</dd>
</dl>
...
1. A title. If possible, use the objective of the meeting. <Q {...q.stanfordReport}>Don't put the word *meeting* or any synonym for it in the title.</Q>
2. The participants. If possible, invite them via the calendar app; this way you ensure they have it in their calendar.
3. Think of how long the meeting should take. If it feels too long, divide the meeting.
4. Put the meeting at a time when your participants are going to be productive.
   <p>*When is the best time to setup a meeting?* Doodle's research reports that <Q {...q.doodle}>70% of professionals reported that meetings are best held in the morning (8am – 12pm), as opposed to the afternoon (19%), and before work/evenings (11%)</Q>.
...
5. Add a link to the [agenda](#define-the-agenda) in the description, if any.
6. Define who is the [Chairman](#define-the-roles-of-people-in-meetings).
7. Explain how to access the meeting: do you need an address, a conference room, or a link?
...
What do you think about this post? Do you have any trick to make a meeting effective, or something to prevent against?

Let's have a conversation on [Mastodon](https://mastodon.social/@bustawin).