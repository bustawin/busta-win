...
2. <C {...q.hbr}>All topics should be thought in advance if they are to be usefully discussed.</C>
...
(a.k.a. note or minute taker). <C {...q.cambridge}>Although the Chairman is the responsible for taking notes, this can be delegated or shared with a participant. The purpose of the minutes is to capture what was discussed, and more importantly, what was agreed at a meeting</C>.
</dd>
<dt>Attendees</dt>
<dd>
