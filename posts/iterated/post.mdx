...
I just released the first version of [iterated](https://github.com/bustawin/iterated),
...
Feel free to [reach the documentation](http://iterated.busta.win) and
check it out by executing `npm i iterated`.
