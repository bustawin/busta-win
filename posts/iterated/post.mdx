...
I explain why Iterables and AsyncIterables in JavaScript are great and why
...
like <Q {...q.e}>Python had it since 2001.</Q>
...
3. [AsyncIterators](#async-iterators), joining promises into iterables to iterate with I/O and API
   calls.
